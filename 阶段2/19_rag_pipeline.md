...
本文档解释 `/Volumes/data/code/me/2026/03/LangChain1.X-/阶段2/19_rag_pipeline.py` 中的代码。
...
- 检索增强生成
- 流程：
  1. **加载文档**: 使用 DocumentLoader
  2. **分割文档**: 使用 TextSplitter
  3. **创建向量库**: 使用 Embeddings + VectorStore
  4. **检索**: 使用 similarity_search
  5. **生成**: 使用 LLM 生成答案
