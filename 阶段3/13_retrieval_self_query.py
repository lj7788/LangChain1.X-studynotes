...
schema = """
The relevant result must satisfy one of the following requirements:
1. The year field is less than or equal to 2010
2. The source field is 'python' or 'javascript'
"""
...
print("\n查询 3：Google 创建的语言")
results3 = self_query_retriever.invoke("Google 创建的语言")
